...
model_list <- read.csv('https://raw.githubusercontent.com/benlistyg/fitsim/master/models.csv?token=AD5GELO5SWMGVWX6FDJUE2S6QEOVI',stringsAsFactors = F)
...
attempt <- function(x) plyr::mdply(.data = simulation_conditions[x,], 
                                   .fun = rep_fit_sim, 
                                   .inform = T)

mclapply(1:nrow(simulation_conditions), attempt, mc.cores = 3)
