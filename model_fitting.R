...
model_list <- read.csv('https://raw.githubusercontent.com/benlistyg/fitsim/master/models.csv',stringsAsFactors = F)
...
out <- plyr::mdply(.data = (simulation_conditions %>% 
